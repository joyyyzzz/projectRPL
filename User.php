            ...
            foreach ($result as $row) {
                ...
                <div class="modal fade" id="ModalView<?php echo $row['id'] ?>" data-bs-backdrop="static"
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Detail Data User</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_user.php"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example"
                                                    ...
                                                    <?php
                                                    $data = array("Manager/Admin", "Pelayan", "Pelanggan");
                ...
                <!-- Modal Delete -->
                <div class="modal fade" id="ModalDelete<?php echo $row['id'] ?>" data-bs-backdrop="static"
                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="col-lg-12">
                                        <?php 
                                        if($row['username'] == $_SESSION['username_waroeng']){
                                            echo "<div class='alert alert-danger'>Anda tidak dapat menghapus akun sendiri</div>";
                                        }else{
                                            echo "Hapus user <b>$row[username]</b>";
                                        }
                                        ?>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger" name="input_user_validate"
                                            value="12345" <?php echo ($row['username'] == $_SESSION['username_waroeng']) ? 'disabled' : '' ; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="btn btn-dark btn-warning btn-sm me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalEdit<?php echo $row['id'] ?>"><i
                                                class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-dark btn-danger btn-sm" data-bs-toggle="modal"
